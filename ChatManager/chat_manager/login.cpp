...
bool CLogin::StartLogin(string loginName, string password, bool isAutoLogin, bool isKeepPwd)
{
	// 先检查登录信息合法
	...
	// 登录
	return LoginToRealServer(m_manager->m_server, m_manager->m_port, uin);
}
