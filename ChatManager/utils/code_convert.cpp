...
//GB2312 转为 UTF-8
void CCodeConvert::Gb2312ToUTF_8(char* pOut, const char *pText, int pLen)
{
	LocalToUTF_8(936,pOut,pText,pLen);
}
//ansi 转为 UTF-8
void CCodeConvert::AnsiToUTF_8(char* pOut, const char *pText, int pLen)
{
...
//GB2312 转为 UTF-8
void CCodeConvert::LocalToUTF_8(UINT CodePage, char* pOut, const char *pText, int pLen)
{
	int len=pLen*2 + 1;
...
//UTF-8 转为 GB2312
void CCodeConvert::UTF_8ToAnsi(char* pOut, const char *pText, int pLen)
{
