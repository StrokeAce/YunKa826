...
public:
	...
	//ansi 转为 UTF-8
	void AnsiToUTF_8(char* pOut, const char *pText, int pLen);

	//UTF-8 转为 GB2312
	void UTF_8ToAnsi(char* pOut, const char *pText, int pLen);
	//
...
private:
	void LocalToUTF_8(UINT CodePage, char* pOut, const char *pText, int pLen);
